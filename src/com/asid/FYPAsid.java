...
public class FYPAsid {
    ...
    public JSONObject doJob(NICData ex,DrivingLsnData ex1,VehicleData ex2,CombineData ex3/*,GovGui ex4*/,String Name) throws JSONException{
       ...
       // String Name="asanka";
        ...
        ResultSet NICCount=ex.NIC("select count(*) as niccount from nic_data where name like '%"+splited[0]+"%' or name like '%"+splited[1]+"%' or Surname like '%"+splited[0]+"%' or Surname like '%"+splited[1]+"%' or FamilyName like '%"+splited[0]+"%' or FamilyName like '%"+splited[1]+"%'");
        ...
        ResultSet DrivingLsnCount=ex1.DrivingLsn("select count(*) as drivecount from drivinglsn_data where full_name like '%"+splited[0]+"%' or full_name like '%"+splited[1]+"%'");
        ResultSet Vehicle=ex2.Vehicle("select * from vehicle_data where full_name like '%"+splited[0]+"%' or full_name like '%"+splited[1]+"%'");
        ResultSet VehicleCount=ex2.Vehicle("select count(*) as vehiclecount from vehicle_data where full_name like '%"+splited[0]+"%' or full_name like '%"+splited[1]+"%'");
        return ex3.Combine(NIC,NICCount, DrivingLsn,DrivingLsnCount, Vehicle, VehicleCount/*,ex4*/);
            ...
            ResultSet NICCount=ex.NIC("select count(*) as niccount from nic_data where name like '%"+splited[0]+"%'  or Surname like '%"+splited[0]+"%'  or FamilyName like '%"+splited[0]+"%' ");
        ResultSet DrivingLsn=ex1.DrivingLsn("select * from drivinglsn_data where full_name like '%"+splited[0]+"%' ");
        ResultSet DrivingLsnCount=ex1.DrivingLsn("select count(*) as drivecount from drivinglsn_data where full_name like '%"+splited[0]+"%' ");
        ResultSet Vehicle=ex2.Vehicle("select * from vehicle_data where full_name like '%"+splited[0]+"%' ");
        ResultSet VehicleCount=ex2.Vehicle("select count(*) as vehiclecount from vehicle_data where full_name like '%"+splited[0]+"%' ");
        return ex3.Combine(NIC,NICCount, DrivingLsn,DrivingLsnCount, Vehicle, VehicleCount/*,ex4*/);
        }
    }
